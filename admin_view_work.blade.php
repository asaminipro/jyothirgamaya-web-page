...
<div class="table-users">
   ...
   <table cellspacing="2" border="4" cellpadding="3">
   	<tr><td colspan="8" height="50"  bgcolor="#20B2AA"><center><b>VOLUNTEER WORKS</b></center></td></tr>
      <tr bgcolor="cyan">
       ...
       <tr bgcolor="cyan">
         <th width="20">ID</th>
         <th width="230">WORKNAAME</th>
         <th>DETAILS</th>
         <th>DAYS</th>
          <th width="20">MEMBERS</th>
         <th width="230">VOLUNTEER</th>
         <th>POSTED ON</th>
         <th>STATUS</th>
	...
	@foreach($viewdata as $datas)
	 ...
	 <td>{{ $datas->created_at }}</td>
	  @if( $datas->workstatus=='0')

          {
            <td> NOT YET STARTED</td>
          }
    @elseif( $datas->workstatus=='1' )
    {
      <td> work started</td>
    }
