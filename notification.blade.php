	  ...
	  <h3>NOTIFICATION</h3>
	   <p class="m_4">"ADD NEW NOTIFICATION HERE!!!!"</p>
		   <form class="contact" action="{{ url('/create') }}" method="post">
			 {{ csrf_field() }}
			  <input type="text" class="text" name="subject" value="SUBJECT" placeholder="TITLE" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Subject';}">
			  
			  <textarea value="description" placeholder="DESCRIPTION" name="description"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Message';}">DESCRIPTION</textarea>
