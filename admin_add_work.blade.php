 ...
 <div class="container">
	...
	<div class="col-md-9 column-9">
	  <h3>VOLUNTEERING WORK</h3>
	   <p class="m_4">"ADD NEW WORK HERE"</p>
		   <form class="contact" action="{{ url('/creatework') }}" method="post" >
		   	 {{ csrf_field() }}
			  <input type="text" class="text" name="w_name" value="WorkName" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'WorkName';}">
			  <input type="text" class="text" value="Location" name="loc" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Location';}">
			  <input type="text" class="text" value="No of days" name="nod" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'No of days';}">
			  <input type="text" class="text" value="No. of Members Needed" name="nom" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'No. of Members Needed';}">
			  <input type="text" class="text" value="No of Volunteers Needed" name="nov" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'No of Volunteers Needed';}">
			   
			  <textarea value="Detailed description" name="des" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Message';}">Detailed description</textarea>
